/* =============================================================================
   AndroidSpect - laptop-first dashboard controller
...
async function previewFile(name, kind) {
    ...
    const header = `
        <div class="toolbar" style="margin-bottom:8px">
            ...
            <a class="btn ghost small" href="${dlUrl}" download="${fmt.esc(name)}" title="Save to laptop">⤓ Download</a>
        </div>`;
    ...
    try {
        ...
        $('#native-list').innerHTML = d.libs.map(l => `
            <div class="native-card">
                ...
                <div class="actions">
                    <button class="btn ghost small" data-so-path="${fmt.esc(l.path)}" data-so-name="${fmt.esc(l.name)}" title="Download to laptop">
